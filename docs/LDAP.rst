...
-  The supported directory implementations are: OpenLDAP and Microsoft Active Directory.
...
6. for Microsoft Active Directory (MSAD) only; do the following sub-steps :
